...
var readCSVService1 = new BaseReadCSVService<CustomerDto>(Path.Combine(basePath, "customers.csv"));
var customers = readCSVService1.ReadRecords();

var readCSVService4 = new BaseReadCSVService<ProductsDto>(Path.Combine(basePath, "products.csv"));
var products = readCSVService4.ReadRecords();

var readCSVService3 = new BaseReadCSVService<OrdersDto>(Path.Combine(basePath, "orders.csv"));
var orders = readCSVService3.ReadRecords();

var readCSVService2 = new BaseReadCSVService<OrderDetailDto>(Path.Combine(basePath, "order_details.csv"));
...
context.Database.ExecuteSqlRaw("DELETE FROM public.\"SaleDetails\"");
context.Database.ExecuteSqlRaw("DELETE FROM public.\"Sales\"");
context.Database.ExecuteSqlRaw("DELETE FROM public.\"Products\"");
context.Database.ExecuteSqlRaw("DELETE FROM public.\"Clients\"");
...
// Order Details
context.SaleDetails.AddRange(saleDetailsList);
await context.SaveChangesAsync();
